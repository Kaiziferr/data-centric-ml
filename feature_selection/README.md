...
**Activities**
- [RFE](https://github.com/Kaiziferr/data-centric-ml/blob/main/feature_selection/02_RFE.ipynb): Practical implementation of RFE for regression and classification models, as well as the use of a function to determine the importance criterion by invoking the 'importance_getter' parameter.
